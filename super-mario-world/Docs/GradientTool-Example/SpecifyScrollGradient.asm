...
;
; This particular variation allows you to specify a gradient rather than load
; the index of a table.
;
; To use scrolling HDMA gradients in this manner, use the following as an
; example.
; In LevelASM INIT:
;     ...
;     SEP     #$10                           ; Force 8-bit X
;     REP     #$20                           ; Force 16-bit A
;     LDA.w   #GradientTableName             ; Address of gradient
;     LDX.b   #GradientTableName>>16         ; Bank # of gradient
;     JSR/JSL SpecifySyncColorGradientInitRt ; (does SEP #$30)
;     ...
;
; In LevelASM:
;     ...
...
;     ...
;
; Add HDMA tables elsewhere. It doesn't matter where as long as it is accessible
; from your LevelASM INIT routine.
;===============================================================================
