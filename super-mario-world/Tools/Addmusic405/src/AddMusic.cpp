...
int main(int argc, char *argv[])
{
	...
	if(b_SE){
		...
		switch(AM.initialize()){
			case 0:
				switch(AM.AMmain()){
					case 0: printf("Insertion has been unsuccessful...\n"); break;
					case 1: printf("Insertion has been successful!\n"); break;
					case 2: printf("No music has been inserted\n"); break;
				}
				break;
			case 1:
				break;
			case 2://unable to find free space
				break;
		}
	}
	if(!header){
