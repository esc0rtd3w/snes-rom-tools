...
.skip_up
	LDA #$00
	JSR SUB_OFF_SCREEN_X0			; suboffscreenX0
	
	LDA $1588,x			; detect walls
	AND #$03
	BEQ .dont_turn
	LDA $157C,x
	EOR #$01
...
.dont_turn
	...
	LDA $1588,x			; detect ground
	AND #$04
	BEQ .not_on_ground
	STZ $AA,x
.not_on_ground

	JSL $81802A			; update x/y position with gravity
	
	LDA $154C,x			; check if player interaction is disabled
	BNE .return
	JSL $81A7DC			; check for contact with the player
	BCC .return
	STZ $14C8,x			; give the player hurt powers
	JSL $00F5B7
.return
	RTS
...
.draw
	...
	STA $02
	LDA $C2,x
	BNE .dont_remove_priority
	LDA #$30
	TRB $02
.dont_remove_priority
	PHX
	LDA $157C,x
	TAX
	LDA $02
