...
SPEED_TABLE         dcb $08,$F8             ; speed of rex, right, left
                    dcb $10,$F0             ; speed of smushed rex, right, left
...
ALIVE               JSR SUB_OFF_SCREEN_REX  ; only process rex while on screen
...
MARIO_WINS          JSR SUB_STOMP_PTS       ; give mario points
                    ...
                    CMP #$02                ;  |   
                    BNE SMUSH_REX           ;  |
                    LDA #$20                ;  |    ... time to show defeated rex = $20
                    STA $1558,x             ; / 
                    RTS                     ; return 

SMUSH_REX           LDA #$0C                ; \ time to show semi-squashed rex = $0C
                    STA $1FE2,x             ; /
...
HORIZ_DISP          dcb $FC,$00,$FC,$00,$FE,$00,$00,$00,$00,$00,$00,$08
                    dcb $04,$00,$04,$00,$02,$00,$00,$00,$00,$00,$08,$00 
VERT_DISP           dcb $F1,$00,$F0,$00,$F8,$00,$00,$00,$00,$00,$08,$08 
TILEMAP             dcb $8A,$AA,$8A,$AC,$8A,$AA,$8C,$8C,$A8,$A8,$A2,$B2 
PROPERTIES          dcb $47,$07             ;xyppccct format

SUB_GFX             LDA $1558,x             ; \ if time to show rex remains > 0...
                    BEQ NOT_DEAD            ; |
                    LDA #$05                ; |    ...set rex frame = 5 (fully squashed)
                    STA $1602,x             ; /
NOT_DEAD            LDA $1FE2,x             ; \ if time to show half smushed rex > 0...
...
LOOP_START          PHX                     ; push current tile number
                    ...
                    BNE FACING_LEFT         ; |
                    CLC                     ; |    
                    ADC #$0C                ; /    ...use row 2 of horizontal tile displacement table
FACING_LEFT         TAX                     ; \ 
