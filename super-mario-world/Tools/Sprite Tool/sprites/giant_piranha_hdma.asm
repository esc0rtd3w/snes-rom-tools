...
Y_SPEED             dcb $00,$F0,$00,$10     ;rest at bottom, moving up, rest at top, moving down
TIME_IN_POS         dcb $20,$30,$20,$30     ;moving up, rest at top, moving down, rest at bottom
...
NO_FIRE             LDA Y_SPEED,y           ; \ set y speed
                    STA $AA,x               ; /
...
LABEL28             LDA $C2,x               ;A:0000 X:0007 Y:0000 D:0000 DB:01 S:01F5 P:envMXdiZcHC:0016 VC:057 00 FL:24235
                    ...
                    ADC #$1E                ;A:00B8 X:0007 Y:0001 D:0000 DB:01 S:01F5 P:eNvMXdizcHC:0502 VC:057 00 FL:24235
                    CMP #$3C                ;A:00D3 X:0007 Y:0001 D:0000 DB:01 S:01F5 P:eNvMXdizcHC:0518 VC:057 00 FL:24235
...
HORIZ_DISP          dcb $FC,$04,$FC,$04,$FC,$04,$FC,$04
VERT_DISP           dcb $F0,$F0,$00,$00,$F0,$F0,$00,$00
TILEMAP             dcb $A4,$A4,$C4,$C4,$C6,$C6,$E6,$E6
PROPERTIES          dcb $00,$40,$00,$40,$00,$40,$00,$40
...
LOOP_START_2        PHX                     ; push, current tile
                    ...
                    ORA #$20                 ; add in tile priority of level
