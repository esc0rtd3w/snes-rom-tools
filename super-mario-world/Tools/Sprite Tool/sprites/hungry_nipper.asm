...
;;
;; NOTE: This sprite assumes the venus fire trap is custom sprite 1A
;;
...
NO_OBJ_CONTACT      JSL $018032             ; interact with sprites
...
SUB_CHECK_CONTACT
L01_A40D            TXA                     
L01_A40E            BEQ RET_A40A
L01_A410            TAY                     
L01_A411            EOR $13    
L01_A413            LSR A                   
L01_A414            BCC RET_A40A
L01_A416            LDX #$0C
L01_A417            
                    LDA $00
                    PHP
...
L01                 PLA
                    ...
                    LDA $14C8,x
L01_A41A            CMP #$08                
L01_A41C            BCS L01_A421
L01_A41E            JMP NEXT_SPRITE
L01_A421            ;LDA $1686,x             ; \ both sprites must have "interact with other sprites"
L01_A424            ;ORA $1686,y             ; |
L01_A427            ;AND #$08                ; /
L01_A429            LDA $1564,x             ; \ time to disable sprite's contact with other sprites
L01_A42C            ORA $1564,y             ; /
L01_A42F            ORA $15D0,x             ; sprite being eaten
L01_A432            ORA $1632,x             ; \ some other Sprite Interaction Disable Flag??
L01_A435            EOR $1632,y             ; /
L01_A438            BEQ L01_A43A
                    JMP NEXT_SPRITE
L01_A43A            STX $1695  
L01_A43D            LDA $E4,x  
L01_A43F            STA $00    
...
L01_A45B            CMP.W #$0020 
L01_A45E            SEP #$20   
L01_A460            BCS L01_A4B0
L01_A462            LDY #$00   
L01_A464            LDA $1662,x
L01_A467            AND #$0F   
L01_A469            BEQ L01_A46C
L01_A46B            INY        
L01_A46C            LDA $D8,x  
L01_A46E            CLC        
L01_A46F            ADC T01_A40B,y
L01_A472            STA $00    
L01_A474            LDA $14D4,x
L01_A477            ADC #$00   
L01_A479            STA $01    
...
L01_A480            LDA $1662,y
L01_A483            AND #$0F   
L01_A485            BEQ L01_A488
L01_A487            INX        
L01_A488            LDA $00D8,y
L01_A48B            CLC        
L01_A48C            ADC T01_A40B,x
L01_A48F            STA $02    
L01_A491            LDA $14D4,y
L01_A494            ADC #$00   
L01_A496            STA $03    
...
L01_A4A6            CMP.W #$0018 
L01_A4A9            SEP #$20   
L01_A4AB            BCS L01_A4B0
L01_A4AD            ;JSR $A4BA               ; do interaction!
                    
                    ;here y is self, x is other sprite
                    LDA $9E,x
                    CMP #$74
                    BNE NEXT
                    STZ $14C8,x
...
NEXT_SPRITE
L01_A4B0            DEX
L01_A4B1            BMI L01_A4B6
L01_A4B3            JMP L01_A417
L01_A4B6            LDX $15E9               ; reload x index
L01_A4B9            RTS                     
